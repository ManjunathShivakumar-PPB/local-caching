...
public class ReadAheadInvalidatingLRUCacheTest extends LRUTestSupport {
    ...
    public void testParallelLoads() {
        ...
        final ReadAheadInvalidatingLRUCache<Integer, Integer> cache = new ReadAheadInvalidatingLRUCache<Integer, Integer>("Test", loader, 0);
    ...
    public void testInvalidate() {
        ReadAheadInvalidatingLRUCache<Integer, Integer> cache = new ReadAheadInvalidatingLRUCache<Integer, Integer>("Test", new IntegerLoader(false, 0), 0);
    ...
    @Test
    public void testReloadOnInvalidate() {
        ReadAheadInvalidatingLRUCache<Integer, Integer> cache = new ReadAheadInvalidatingLRUCache<Integer, Integer>("Test", new Loader<Integer, Integer>() {
            @Override
    ...
    @Test
    public void testReadThroughAfterInvalidateDoesNotCauseALoad() {
        ReadAheadInvalidatingLRUCache<Integer, Integer> cache = new ReadAheadInvalidatingLRUCache<Integer, Integer>("Test", new Loader<Integer, Integer>() {
            int ref = 0;
    ...
    @Test
    public void testReloadOnInvalidateAll() {
        ReadAheadInvalidatingLRUCache<Integer, Integer> cache = new ReadAheadInvalidatingLRUCache<Integer, Integer>("Test", new Loader<Integer, Integer>() {
            @Override
            public Integer load(Integer key) {
                return key;
    ...
    public void testJMXReset() throws Exception {
        ReadAheadInvalidatingLRUCache<Integer, Integer> cache = new ReadAheadInvalidatingLRUCache<Integer, Integer>("Test", new IntegerLoader(false, 10), 0, 10, 20, 15);
    ...
    public void testForcedPruning() throws Exception {
        ...
        ReadAheadInvalidatingLRUCache<Integer, Integer> cache = new ReadAheadInvalidatingLRUCache<Integer, Integer>("Test", new IntegerLoader(true, 0), 0, 10, 20, 15);
    ...
    public void testBulkLoad() throws Exception {
        ...
        ReadAheadInvalidatingLRUCache<Integer, Integer> cache = new ReadAheadInvalidatingLRUCache<Integer, Integer>("Test", loader, 0, 0, 0, 0);
    ...
    public void testInvalidateBlockingRead() throws Exception {
        ...
        Assert.assertEquals(0, cache.getReadAheadRequests());
        Assert.assertEquals(1, cache.getReloadOnInvalidationCount());
    }

    @Test
    public void testSizeEvictions() throws Exception {
        long startTime = System.currentTimeMillis();
        ReadAheadInvalidatingLRUCache<Integer, Integer> cache = new ReadAheadInvalidatingLRUCache<Integer, Integer>("Test", new IntegerLoader(false, 0), 0, 100, 10, 6);
    ...
    public void testSingleInvalidations() throws Exception {
        ...
        // reload
        Assert.assertEquals(3, cache.get(1).intValue());
    ...
    public void testExpiry() throws Exception {
        ReadAheadInvalidatingLRUCache<Integer, Integer> cache = new ReadAheadInvalidatingLRUCache<Integer, Integer>("Test", new IntegerLoader(false, 0), 100);
    ...
    public void testLRUEvictions() throws Exception {
        ReadAheadInvalidatingLRUCache<Integer, Integer> cache = new ReadAheadInvalidatingLRUCache<Integer, Integer>("Test", new IntegerLoader(false, 0), 0, 1000, 3, 3);
    ...
    private void populateCache(ReadAheadInvalidatingLRUCache<Integer, Integer> cache, int entries, int sleepBetweenAdditions) throws Exception {
